...
through the contact listed on the [organisation profile](https://github.com/LWSNLab),
with "CareGraph conduct" in the subject.

All complaints will be reviewed and investigated promptly and fairly. All
community leaders are obligated to respect the privacy and security of the
reporter of any incident.

This is a small project. Reports are read by the maintainers, who may also be
the people a report is about — if that makes a report impossible to raise, say
so publicly or not at all, and it will be taken seriously either way.
